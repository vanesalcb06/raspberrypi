...
default_args = {
  ...
  'mqtt_broker' : '78f67533bac5450fab88911a3bc11b80.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_tssproject2-2b5c", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_tssproject2-2b5c"], schedule=None,catchup=False)
